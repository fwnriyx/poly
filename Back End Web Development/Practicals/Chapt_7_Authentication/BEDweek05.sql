...
-- SELECT full_name, id, username FROM user LIMIT 3;
-- SELECT full_name, id, username FROM user ORDER BY full_name ASC LIMIT 3;
...
-- The following sql will generate an error as user 999 does not exists
